...
export const christmasLanding: EventLanding = {
  ...
  subhead:
    "Six weeks of lights along the Waccamaw, a hometown parade, and a market full of Horry County makers.",
  metaDescription:
    "Christmas in Conway: tree lighting, the holiday parade, downtown market, Wonderland of Lights, parking, road closures, and the full December schedule.",
  hero: heroChristmas,
  heroAlt: "Conway's Main Street at blue hour with lit garland wreaths on lampposts and shop windows aglow",
  ...
  events: [
    {
      ...
      categories: ["Family", "Free", "Downtown"],
      image: heroChristmas,
      alt: "Crowd gathered around a lit Christmas tree on a city hall lawn",
    },
    {
      title: "Wonderland of Lights",
      day: 5,
      ...
      categories: ["Family", "Free", "Downtown"],
      image: prideRiver,
      alt: "Riverwalk boardwalk lined with holiday lights along the Waccamaw",
    },
    {
      ...
      categories: ["Family", "Free", "Downtown"],
      image: evCostume,
      alt: "Crowd lining Main Street for a hometown holiday parade",
    },
    {
      ...
      categories: ["Family", "Free", "Downtown"],
      image: evMarket,
      alt: "Vendor stalls on a downtown street at a holiday market",
    },
    {
    ...
    {
      title: "Santa on the Riverwalk",
      day: 19,
      date: "Saturday, December 19",
      time: "5 p.m. – 8 p.m.",
      location: "Riverfront Park",
      categories: ["Family", "Free"],
      image: prideUniversity,
      alt: "Families gathered at a riverfront park holiday event",
    },
    ...citywide.map((e) => ({ ...e, day: e.day, date: e.date.replace("October", "December") })),
  ],
  mapPins: [
    { label: "Parade route", top: "30%", left: "48%" },
    { label: "Road closure", top: "58%", left: "24%" },
  ...
  visitInfo: [
    ...
    {
      heading: "Accessibility",
      body: "An accessible parade viewing area is reserved at 4th Avenue. The Riverwalk light trail is fully paved, lit, and stroller- and wheelchair-friendly end to end.",
    },
    {
      heading: "What to bring",
  ...
  gallery: [
    { src: heroChristmas, alt: "Main Street decorated with wreaths and lights at blue hour", caption: "Main Street, 2025" },
    { src: prideRiver, alt: "Waccamaw River at dusk", caption: "Wonderland of Lights" },
    { src: evMarket, alt: "Holiday market stalls downtown", caption: "Holiday Market" },
    { src: evCostume, alt: "Crowds at a hometown parade", caption: "Parade, 2025" },
    { src: prideMural, alt: "Downtown mural on brick", caption: "Downtown Conway" },
    { src: prideUniversity, alt: "Coastal Carolina University campus", caption: "CCU carol night" },
  ],
  press: [
    "Hallmark Channel — “Merriest Christmas Town” nominee",
